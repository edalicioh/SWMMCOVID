    ...
    <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="form-group">
            ...
            <select class="form-control  state {{ $errors->has('state_id') ? 'is-invalid' : '' }}" id="state" name="state_id">
          ...
          <div class="form-group">
            ...
            <select class="form-control city {{ $errors->has('city_id') ? 'is-invalid' : '' }}" id="city" name="city_id">
          ...
          <div class="form-group">
            ...
            <select class="form-control district {{ $errors->has('district_id') ? 'is-invalid' : '' }}" id="district" name="district_id">
