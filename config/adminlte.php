        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Lista',
                    'url'  => '/admin/hospital',
                    'icon'    => 'fas fa-fw fa-list-ul mr-2',
                ],
                [
                    'text' => 'Adicionar',
                    'url'  => 'admin/hospital/create',
                    'icon'    => 'fas fa-fw fa-hospital mr-2',
                ],
            ],
        ],
        ['header' => 'Questionário'],
        ...
        [
            ...
            'files' => [
                ...
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => '//cdn.datatables.net/plug-ins/1.10.21/dataRender/datetime.js',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                ...
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => '//cdn.datatables.net/plug-ins/1.10.21/filtering/row-based/range_dates.js',
                ],
                [
                    'type' => 'css',
                    'asset' => true,
        ...
        [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => '//cdnjs.cloudflare.com/ajax/libs/moment.js/2.26.0/moment.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
